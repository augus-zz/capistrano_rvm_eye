Eye.application 'KerryInfrasys' do
  ...
  group :sidekiq do
    {
      ...
      process k do
        ...
        start_command "/bin/bash -l -c 'bundle exec sidekiq -C config/sidekiq#{v}.yml -e production -d'"
  ...
  process :ably do
    ...
    start_command "/bin/bash -l -c 'RACK_ENV=production bundle exec ruby ably_app.rb'"
